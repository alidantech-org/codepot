...
from archives.codepotg.src.languages.dart.operations import operations_for_resource
from archives.codepotg.src.languages.dart.paths import resource_path_for_resource
