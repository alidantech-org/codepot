...
from archives.codepotg.src.inference.models import InferredSchemaKind
...
def classify_schema(
    ...
    if REF in schema and document is not None:
        from archives.codepotg.src.inference.ref_metadata import infer_kind_from_ref_alias
