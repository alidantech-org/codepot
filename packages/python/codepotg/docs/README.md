...
- [Adaptive performance architecture](performance.md) defines the SQLite lookup index, JSONL raw sections, host-aware memory budgets, Jinja caching, batched writes, and headless selected-document foundation.
