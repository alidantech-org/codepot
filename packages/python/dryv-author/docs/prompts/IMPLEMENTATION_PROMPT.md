# AI implementation prompt: build `dryv-author`

Implement the typed Python authoring compiler for Dryv.
...
Feature branch: chatgpt/codepotx-restart-dryv-author
Package: packages/python/dryv-author
Core: packages/python/dryv
```
...
git switch -c chatgpt/codepotx-restart-dryv-author
```
...
Build a concise, strongly typed Python authoring frontend that compiles declarations into the existing public immutable `dryv.ir.Contract` and supports canonical JSON/YAML round-trip transport.
...
packages/python/dryv/docs/01-foundation/01-package-architecture.md
packages/python/dryv/docs/03-generation/README.md
packages/python/dryv/docs/04-plugins/README.md
packages/python/dryv/docs/tasks/PARALLEL_WORK.md

packages/python/dryv-author/README.md
packages/python/dryv-author/docs/README.md
packages/python/dryv-author/docs/IDEA.md
packages/python/dryv-author/docs/design/*.md
packages/python/dryv-author/docs/tasks/00-master-plan.md
packages/python/dryv-author/docs/tasks/01-dependencies-and-parallelism.md
packages/python/dryv-author/docs/tasks/PARALLEL_WORK.md
packages/python/dryv-author/docs/tasks/PROGRESS.md
```

The approved v2 architecture and `dryv-author` design override Dryv 1.0.0 and archived rewrite patterns.
...
The new package must not import Dryv 1.0.0 or Node code.
...
From `packages/python/dryv-author` in a clean environment:
...
docs(dryv-author): record support blockers and verification evidence
```
...
```bash
git fetch origin
git switch chatgpt/codepotx-restart-dryv-author
git merge --no-edit origin/chatgpt/codepotx-restart
```
...
```bash
git push -u origin chatgpt/codepotx-restart-dryv-author

git switch chatgpt/codepotx-restart
git pull --ff-only origin chatgpt/codepotx-restart
git merge --no-ff chatgpt/codepotx-restart-dryv-author \
  -m "merge: integrate Dryv Python authoring compiler"
