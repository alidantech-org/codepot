...
There is one semantic authority. `dryv-author` does not create a Contract Graph beside the IR, does not generate files, and does not bypass planning or packs.
...
- depend on Dryv 1.0.0 internals;
