...
from dryv.ir import TypeExpression, TypeKind
from pydantic import BaseModel
from pydantic.fields import FieldInfo

from dryv_author.refs import GroupRef, SchemaRef
from dryv_author.schemas import (
    FieldDeclaration,
    FieldOptions,
    SchemaDeclaration,
...
if TYPE_CHECKING:
    from dryv_author.author import Author
