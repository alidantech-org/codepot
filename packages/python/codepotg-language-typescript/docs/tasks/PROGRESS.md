...
- Strictly validate direct option construction and add negative tests.
- Ensure post-build wheel/sdist inspection cannot skip.
- Run Ruff, format, complete core/package suites, and `python -m build` on the synchronized checkout.
