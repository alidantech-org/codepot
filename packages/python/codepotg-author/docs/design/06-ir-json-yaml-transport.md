...
`codepotg-author` must compile to an immutable core contract and support readable JSON/YAML for debugging, review, caching, transport, and reuse as a direct semantic input.
