...
| 2026-07-27 | `6cea4ad7` | Shared parallel lane | complete | Coordination-document review only. | Registered `codepotg-author` as an independent package lane. |
...
| 2026-07-27 | `3e3b3e5d` | Typed semantics, projections, Pydantic v2, and public IR compiler | implementation complete; verification pending | Source-level contract audit against public `codepotg.ir`. | Added typed operation/event/policy/storage/view/workflow payloads, recursive model discovery, deterministic schema dependency ordering, projection expansion, enum validation, and immutable public IR assembly. |
...
| 2026-07-27 | `b8411b71` | Six-package connectability audit | fix required / review | See `docs/tasks/AUDIT_FIXES.md` and the connected manual workspace under `codepotg-v2/examples/manual/connected-project`. | Recorded one canonical-transport owner, synchronized release commands, and evolved-core authoring gaps. |
...
- deterministic public `codepotg.ir.Contract` compilation;
