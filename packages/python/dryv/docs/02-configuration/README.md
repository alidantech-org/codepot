...
Dryv has two authored YAML contracts:

- `dryv.yaml` — project-owned sources, executables, commands, and pack instances;
- `DryvPack.yaml` — pack identity, options, bindings, root-first fixed selections, generated dependencies, symbols, and pack commands.
