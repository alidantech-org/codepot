# Verify, repair, complete, and audit the Dryv orchestrator

You are completing and independently auditing the first production Dryv orchestration runtime.
...
```text
packages/python/dryv/docs/00-governance/00-approved-architecture.md
packages/python/dryv/docs/00-governance/01-agent-working-rules.md
packages/python/dryv/docs/00-governance/03-glossary-and-ownership.md
packages/python/dryv/docs/00-governance/04-closed-semantic-kernel.md
```

## Authoring-aligned IR

```text
packages/python/dryv/docs/01-foundation/05-authoring-aligned-ir.md
packages/python/dryv/docs/01-foundation/06-canonical-ir-transport.md
packages/python/dryv-author/docs/IDEA.md
packages/python/dryv-author/docs/design/01-architecture-and-boundaries.md
packages/python/dryv-author/docs/design/02-ref-engine.md
packages/python/dryv-author/docs/design/03-authoring-model.md
packages/python/dryv-author/docs/design/05-transport.md
```

## Project, pack, and generation

```text
packages/python/dryv/docs/02-configuration/01-project-config-specification.md
packages/python/dryv/docs/02-configuration/02-pack-manifest-specification.md
packages/python/dryv/docs/03-generation/01-template-file-model.md
packages/python/dryv/docs/03-generation/02-selection-folder-patterns-and-static-files.md
packages/python/dryv/docs/03-generation/03-planning-execution-and-transaction.md
packages/python/dryv/docs/03-generation/04-orchestrator-runtime.md
packages/python/dryv/docs/03-generation/05-template-context-contract.md
```

## Tasks and evidence

```text
packages/python/dryv/docs/tasks/00-master-plan.md
packages/python/dryv/docs/tasks/ORCHESTRATOR_PLAN.md
packages/python/dryv/docs/tasks/PARALLEL_WORK.md
packages/python/dryv/docs/tasks/PROGRESS.md
```

## Adapter boundaries

```text
packages/python/dryv/src/dryv/ports/source.py
packages/python/dryv/src/dryv/ports/templates.py
packages/python/dryv/src/dryv/ports/target.py
packages/python/dryv/docs/04-plugins/01-plugin-system.md
packages/python/dryv/docs/04-plugins/02-language-adapter-contract.md
packages/python/dryv/docs/04-plugins/03-template-engine-adapter-contract.md
```
...
There is one closed neutral `dryv.ir.Contract`.
...
```text
packages/python/dryv/src/dryv/config/**
packages/python/dryv/src/dryv/domain/ir/**
packages/python/dryv/src/dryv/domain/generation/**
packages/python/dryv/src/dryv/generation/**
packages/python/dryv/src/dryv/runtime/**
packages/python/dryv/src/dryv/application/**
packages/python/dryv/src/dryv/infrastructure/**
packages/python/dryv/src/dryv/cli/**
packages/python/dryv/src/dryv/ir/codec.py
packages/python/dryv-template-jinja/src/dryv_template_jinja/context/**
packages/python/dryv-template-jinja/src/dryv_template_jinja/sandbox/**
```
...
packages/python/dryv-template-jinja/tests/integration/test_tag_queries.py
```
...
- no old `packages/python/dryv` implementation is imported;
...
```text
packages/python/dryv-openapi/docs/tasks/AUDIT_FIXES.md
packages/python/dryv-language-typescript/docs/tasks/AUDIT_FIXES.md
packages/python/dryv-language-dart/docs/tasks/AUDIT_FIXES.md
```
...
```text
packages/python/dryv/README.md
packages/python/dryv/docs/README.md
packages/python/dryv/docs/03-generation/README.md
packages/python/dryv/docs/tasks/00-master-plan.md
packages/python/dryv/docs/tasks/ORCHESTRATOR_PLAN.md
packages/python/dryv/docs/tasks/PARALLEL_WORK.md
packages/python/dryv/docs/tasks/PROGRESS.md
packages/python/dryv-author/docs/IDEA.md
packages/python/dryv-author/docs/tasks/00-package-plan.md
packages/python/dryv-author/docs/tasks/PROGRESS.md
```
...
git merge --no-ff chatgpt/codepotx-restart-orchestrator \
  -m "merge: integrate Dryv generation orchestrator"
