...
When a repeated real-world need requires a filtered view, Dryv adds a named fixed selector through a kernel/selection behavior version.
...
Another target may author different syntax from the same facts. Dryv and language adapters do not inject import statements.
