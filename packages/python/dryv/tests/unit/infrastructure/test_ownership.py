...
from dryv.generation import GeneratedArtifact, MemoryOutput
from dryv.infrastructure import ManagedFilesystemWriter, ManagedWriteKind
...
def test_managed_writer_tracks_changes_and_deletes_unchanged_stale_files(
    ...
    assert (tmp_path / ".dryv" / "generation-state.json").is_file()
