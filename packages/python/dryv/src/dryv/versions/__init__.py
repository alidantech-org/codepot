...
PUBLIC_API_VERSION = ApiVersion("dryv.public", Version.parse("2.0.0"))
IR_API_VERSION = ApiVersion("dryv.ir", Version.parse("2.0.0"))
PLUGIN_API_VERSION = ApiVersion("dryv.plugin", Version.parse("1.0.0"))
