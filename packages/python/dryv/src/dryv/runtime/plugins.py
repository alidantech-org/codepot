...
from dryv.plugins import PluginRegistry
...
class RuntimePlugins:
    ...
    def discover(cls) -> RuntimePlugins:
        return cls(
            source_adapters=_load_group("dryv.source_adapters", SourceAdapter),
            target_adapters=_load_group("dryv.language_adapters", TargetAdapter),
            template_engines=_load_group("dryv.template_engines", TemplateEngine),
        )
