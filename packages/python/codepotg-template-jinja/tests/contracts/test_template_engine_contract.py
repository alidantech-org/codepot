...
from codepotg.plugins import PluginCategory, PluginTrust
from codepotg.ports import RenderRequest, TemplateEngine
from codepotg.testing import assert_template_engine_conformance
from codepotg.versions import IR_API_VERSION, PLUGIN_API_VERSION
...
def test_descriptor_is_truthful_and_compatible() -> None:
    ...
    assert descriptor.distribution == "codepotg-template-jinja"
