...
from codepotg.versions import IR_API_VERSION, PLUGIN_API_VERSION, BehaviorVersion, Version
...
def test_full_orchestrator_plans_dependencies_and_renders_to_memory(tmp_path) -> None:
    ...
    (pack / "CodepotgPack.yaml").write_text(
        """
...
""".strip(),
    ...
    project = tmp_path / "codepotg.yaml"
    project.write_text(
        """
apiVersion: codepotg.dev/v2
name: example
