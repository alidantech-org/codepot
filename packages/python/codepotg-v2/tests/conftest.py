...
def build_connected_contract() -> Contract:
    ...
    storage = StorageMapping(
        ...
        fields=(
            ...
            StorageFieldMapping(field=user_email_id, column="email", column_type="varchar", unique=True),
        ),
    ...
    return Contract(id=sid("application.identity"), name=Name("IdentityApplication"), groups=(group,))
