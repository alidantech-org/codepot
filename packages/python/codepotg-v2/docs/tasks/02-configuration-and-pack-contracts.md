...
**Acceptance:** `codepotg.yaml`, `CodepotgPack.yaml`, and `codepotg.lock.yaml` decode only through documented v2 families.
...
**Acceptance:** CodepotG schedules exact arguments without understanding npm/pnpm/Flutter/Dart syntax in semantic core.
...
**Acceptance:** a pack can configure authored templates and approved commands without redefining CodepotG semantics.
