...
| AUTHOR-001..AUTHOR-013, AUTHOR-015..AUTHOR-020, AUTHOR-022, AUTHOR-024, AUTHOR-027..AUTHOR-030 | `codepotg-author` typed Python authoring compiler and canonical IR transport | GPT-5.6 Thinking / CODEPOT continuation (`chatgpt/codepotx-restart-codepotg-author`) | in_progress | `packages/python/codepotg-author/**`; coordination updates in this file only | Public `codepotg.ir`, `codepotg.diagnostics`, naming, versions, and validation facades through merged base `43aa0a18` | Foundation merged in PR #35. Audit fixes continue on the same feature branch. AUTHOR-014, AUTHOR-021, AUTHOR-023, AUTHOR-025, AUTHOR-026, extended AUTHOR-019, and shared canonical-codec ownership in AUTHOR-028 remain blocked on public core contracts. |
...
| Conservative incremental generation | PLAN-012 | planner/cache/state | deterministic full generation and impact analysis proven |
