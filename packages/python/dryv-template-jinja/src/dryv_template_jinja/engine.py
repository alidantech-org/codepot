...
from dryv.versions import IR_API_VERSION, PLUGIN_API_VERSION, Version
from dryv_template_jinja.caching import (
    BoundedCache,
    CacheStats,
    sha256_text,
    stable_identity,
)
from dryv_template_jinja.context import ContextSafetyError, freeze_context
from dryv_template_jinja.diagnostics import (
    error_diagnostic,
...
from dryv_template_jinja.sandbox import OutputAccumulator, RenderLimitError, create_environment
from dryv_template_jinja.templates import (
    AnalysisResult,
...
PLUGIN_DESCRIPTOR: Final = PluginDescriptor(
    ...
    distribution="dryv-template-jinja",
    ...
    documentation=(
        ...
        "chatgpt/codepotx-restart/packages/python/dryv-template-jinja"
    ),
)
...
class JinjaTemplateEngine:
    """Strict deterministic adapter for the public Dryv TemplateEngine port."""
