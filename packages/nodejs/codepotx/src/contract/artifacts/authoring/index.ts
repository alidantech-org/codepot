import type { ArtifactHeader, CompiledDocumentation, CompiledNamedItem } from '../../protocol/artifact.types';
import type { CodepotId, JsonObject, JsonValue } from '../../protocol/common.types';
import type { Diagnostic } from '../../diagnostics/diagnostic.types';
import type { ResolvedSource } from '../../sources/source.types';
