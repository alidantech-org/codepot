import type { FileWriteStatus } from '../artifacts/generation/index';
import type { Diagnostic, DiagnosticLayer } from '../diagnostics/index';
import type { ArtifactReference } from '../protocol/artifact.types';
import type {
  CodepotId,
  IsoTimestamp,
  JsonObject,
