...
Dryv discovers independently installable Python adapters/infrastructure packages through standard Python entry points. Official packages receive no hidden privileges.
...
dryv.pack_providers
dryv.ecosystem_adapters
dryv.artifact_writers
dryv.cache_stores
dryv.command_executors
```
