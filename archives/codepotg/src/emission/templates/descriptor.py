...
from archives.codepotg.src.contracts.paths import PathToken, PathTokenKind
from archives.codepotg.src.emission.templates.path_tokens import PathSegment, parse_path_segments
