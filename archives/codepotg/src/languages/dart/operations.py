...
from archives.codepotg.src.languages.dart.dependencies import dependency
from archives.codepotg.src.languages.dart.names import name_text, safe_dart_identifier
