...
from archives.codepotg.src.inference.schemas.field_types import ResolvedFieldType, infer_field_type
...
def _infer_field(
    ...
    from archives.codepotg.src.inference.schemas.composition import split_nullable_union
