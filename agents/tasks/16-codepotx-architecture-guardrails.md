...
Validation: strict library and test typecheck passed; CodepotX tests passed 40/40; library ESM build passed; Publint passed; Are The Types Wrong passed for the supported ESM and bundler profiles; CLI typecheck passed; CLI tests passed 3/3; CLI ESM build, Publint, and supported package-resolution checks passed. Issue #14 closed on 2026-07-23.
...
- [x] Run Publint and Are The Types Wrong successfully.
- [x] Run external CLI typecheck, tests, build, and package lint successfully (3 passed, 0 failed).
...
- [x] All package and CLI checks pass.
