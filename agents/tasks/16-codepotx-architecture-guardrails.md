...
- [ ] Run strict package typecheck and record passing output.
- [ ] Run all CodepotX tests and record passing test count.
...
- [ ] Existing behavior remains unchanged under the full passing suite.
