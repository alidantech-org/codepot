...
const source = [
  ...
  `export const DOC_TOCS = ${JSON.stringify(tablesOfContents, null, 2)} as const;`,
...
console.log(
  `Synced ${Object.keys(documents).length} public documentation files, tables of contents, and ecosystem metadata.`,
);
