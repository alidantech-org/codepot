...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://code.alidantech.org';
  ...
  '@graph': [
    {
      ...
      url: siteUrl,
      name: 'Codepot',
      description: 'Typed software intent, reusable template packs, safe generation, and language tooling.',
