...
export function Hero() {
  return (
    <section className="relative flex px-3 md:px-6 min-h-[620px] max-w-7xl mx-auto flex-col items-center justify-center py-24 text-center sm:items-start sm:text-left lg:min-h-[680px] lg:py-28 lg:pr-72 xl:pr-80">
      <span className="mb-6 inline-flex items-center gap-2 border-t border-border/70 border-b py-1 font-mono text-[11px] tracking-wider text-primary">
        <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-primary hidden md:block" />
        supported prototypes · official runtime · Rust language platform
      </span>

      <h1 className="landing-display max-w-4xl text-3xl font-semibold leading-[1.03] tracking-tight text-foreground md:text-6xl lg:text-7xl">
      ...
      <p className="mt-6 max-w-3xl text-sm sm:text-lg leading-8 text-muted-foreground">
      ...
      <div className="mt-8 flex w-full flex-col gap-3 sm:w-auto sm:flex-row px-3 sm:px-0">
        <Link
