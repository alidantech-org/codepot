...
export function CTABanner() {
  return (
    <section className="relative mb-24 overflow-hidden rounded-[2.5rem_1.5rem_4.5rem_1.5rem] border border-primary/25 bg-[linear-gradient(135deg,#21130c_0%,#3b2114_52%,#24140c_100%)] px-6 py-14 text-center shadow-2xl shadow-primary/10 sm:px-12 sm:py-16 dark:border-primary/20">
