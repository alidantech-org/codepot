...
export function Features({ features }: { features: Feature[] }) {
  return (
    <section
      id="features"
      className="relative my-14 max-w-7xl overflow-hidden rounded-[1.5rem_1rem_2.5rem_1rem] border border-border bg-card 
      px-3 py-8 shadow-lg shadow-primary/5 sm:my-16 sm:rounded-[2.25rem_1.5rem_3.5rem_1.5rem] sm:px-4 sm:py-10 lg:mx-auto lg:my-20 lg:px-6 lg:py-14"
    >
      ...
      <div className="relative z-10 py-10">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-[15px] sm:leading-7">
          Each package has a deliberate role. Contracts describe intent, template systems preserve real project
          conventions, runtimes coordinate safe work, and language tooling makes the same meaning available to editors
          and AI.
        </p>
