...
from archives.codepotg.src.utils.naming.aliases import CASE_ALIAS_TO_FIELD
from archives.codepotg.src.utils.naming.cases import (
    camel_case,
    clean_name,
    constant_case,
    dot_case,
...
from archives.codepotg.src.utils.naming.number import NumberKind
from archives.codepotg.src.utils.naming.plurality import categorize_word
