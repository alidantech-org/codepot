...
- [x] Register `jinja` factory in `dryv.template_engines`.
...
- [x] Accept safe scalars, tuples, sorted tuple-pair mappings, public frozen Dryv IR values, approved enums, and narrow helper descriptors.
...
- [x] Run the complete real `dryv` suite and build.
