...
`dryv-author` is a trusted executable Python frontend that compiles concise typed declarations into the public immutable `dryv.ir.Contract`.
...
dryv_author.Author
dryv_author.Model
dryv_author.field / constraints / tags / info
dryv_author.refs.*
dryv_author.operations.*
dryv_author.facets.*
dryv_author.transport.*
dryv_author.result.AuthoringResult
```
